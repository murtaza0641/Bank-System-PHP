...
//it gets the absolute path to this file, then we append the relative url (so up a directory
and inside lib)
...
//the default fetch mode is FETCH_BOTH which returns the data as both an indexed array
